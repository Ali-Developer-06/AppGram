...
mm.add("(max-width: 768px)", () => {
    gsap.utils.toArray(".aboutBox").forEach(box => {
        gsap.from(box, {
        y: 50,
        opacity: 0,
        scrollTrigger: {
...
const jj = gsap.matchMedia();
jj.add("(min-width: 769px)", () => {
...
jj.add("(max-width: 768px)", () => {
    gsap.utils.toArray(".serviceCard").forEach(box => {
        gsap.from(box, {
        y: 50,
        opacity: 0,
        scrollTrigger: {
...
const kk = gsap.matchMedia();
kk.add("(min-width: 769px)", () => {
...
kk.add("(max-width: 768px)", () => {
    gsap.utils.toArray(".processBox").forEach(box => {
        gsap.from(box, {
        y: 50,
        opacity: 0,
        scrollTrigger: {
